...
%\ins{
\chg{We will}{In this section we} demonstrate the value of \chg{the framework and of the SoS viewpoint specifically based on our experience of applying it to the \emph{take-over} scenario.}{the SoS viewpoint described in this paper and consequently also of the architecture framework that has been proposed in~\cite{JSA2017}. Specifically, we base the validation on our experience of applying the SoS viewpoint to the \emph{take-over} scenario. This is an additional scenario with respect to those described in Section~\ref{sec:scenarios} and it is described here in the following.} 
...
As soon as the driver of \chg{car}{Car A} indicates her goal to overtake, Car B will share information of their sensors.
...
%\ins{
During a workshop with representatives of several participating companies, we applied the \chg{questions}{stakeholders' concerns} from our SoS viewpoint (see Table~\ref{tab:sos-concerns}). 
